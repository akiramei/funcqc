...
`;
  ...
  private generateHelperFunctionsFile(typeGeneration: TypeGenerationPlan): string {
    let content = `/**
 * Helper Functions for ${typeGeneration.unionType.typeName}
 * Generated by funcqc DU transformation
 */

import type { ${typeGeneration.unionType.typeName} } from '../types/${typeGeneration.unionType.typeName.toLowerCase()}.types';

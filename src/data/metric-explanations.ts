...
export const METRIC_EXPLANATIONS: Record<string, MetricExplanation> = {
  cyclomaticComplexity: {
    ...
    category: 'complexity',
    definition:
      "Measures the number of linearly independent paths through a function's control flow.",
    purpose:
      'Indicates testing effort required and maintenance difficulty. Higher values suggest more complex logic flow that is harder to understand and test.',
    calculation:
      'CC = Edges - Nodes + 2P, where P is the number of connected components. Practically: start with 1 and add 1 for each decision point (if, while, for, case, etc.).',
    thresholds: {
    ...
    industryStandards:
      'Most organizations set CC <= 10. Critical systems often use CC <= 5. Some legacy systems tolerate CC <= 15.',
    bestPractices: [
  ...
  cognitiveComplexity: {
    ...
    category: 'complexity',
    definition:
      'Measures how difficult it is for humans to understand a function based on control flow and nesting.',
    purpose:
      'Focuses on human readability rather than just path count. Emphasizes the mental effort required to understand code.',
    calculation:
      'Increments based on nesting level and specific constructs. Deeply nested code receives higher penalties.',
    thresholds: {
    ...
    industryStandards:
      'SonarQube recommends CC <= 15. Many teams use CC <= 20 for regular functions.',
    bestPractices: [
  ...
  linesOfCode: {
    ...
    purpose:
      'Indicates function size and potential complexity. Larger functions are generally harder to understand, test, and maintain.',
    calculation:
      'Count all lines containing executable code statements, excluding comments, blank lines, and closing braces only.',
    thresholds: {
    ...
    industryStandards:
      'Clean Code suggests functions should fit on a screen (20-30 lines). Many teams use 40-50 lines as upper limit.',
    bestPractices: [
  ...
  totalLines: {
    ...
    category: 'size',
    definition:
      'Total count of all lines in the function, including comments, blank lines, and code.',
    purpose:
      'Provides overall function size including documentation. Useful for understanding the complete footprint of a function.',
    ...
    industryStandards:
      'Generally should be proportional to lines of code. Well-documented functions may have higher total lines.',
    bestPractices: [
  ...
  parameterCount: {
    ...
    purpose:
      'Indicates function interface complexity. Too many parameters suggest the function may be doing too much or needs refactoring.',
    ...
    industryStandards:
      'Clean Code suggests 3 parameters max. Many teams allow up to 4-5 parameters. Beyond 7 is generally discouraged.',
    bestPractices: [
  ...
  maxNestingLevel: {
    ...
    category: 'structure',
    definition:
      'The deepest level of nested control structures (if, for, while, etc.) within the function.',
    purpose:
      'Indicates code structure complexity. Deep nesting makes code harder to read and understand.',
    calculation:
      'Count the maximum depth of nested control structures. Each if, for, while, etc. increases nesting level.',
    thresholds: {
    ...
    industryStandards:
      'Most coding standards recommend maximum 3-4 levels. Some strict standards limit to 2 levels.',
    bestPractices: [
  ...
  branchCount: {
    ...
    category: 'structure',
    definition:
      'Number of conditional branches (if-else, switch-case, ternary operators) in the function.',
    purpose:
      'Indicates decision complexity and testing requirements. More branches mean more test cases needed.',
    ...
    industryStandards:
      'Varies by function purpose. Business logic functions may have more branches than utility functions.',
    bestPractices: [
  ...
  loopCount: {
    ...
    purpose:
      'Indicates iterative complexity. Multiple loops can affect performance and readability.',
    ...
    industryStandards:
      'No strict standards, but nested loops and multiple loops in one function often indicate complexity.',
    bestPractices: [
  ...
  returnStatementCount: {
    ...
    purpose:
      'Indicates control flow complexity. Multiple returns can make function flow harder to follow.',
    ...
    industryStandards:
      'Debated topic. Some prefer single return, others allow multiple early returns for guard clauses.',
    bestPractices: [
  ...
  tryCatchCount: {
    ...
    purpose:
      'Indicates error handling complexity. Multiple try-catch blocks may suggest function handling too many concerns.',
    ...
    industryStandards:
      'Generally prefer specific error handling. Multiple try-catch blocks often indicate need for refactoring.',
    bestPractices: [
  ...
  asyncAwaitCount: {
    ...
    purpose:
      'Indicates asynchronous complexity. Multiple async operations may suggest coordination complexity.',
    ...
    industryStandards:
      'No strict standards, but many sequential awaits may indicate performance or design issues.',
    bestPractices: [
  ...
  callbackCount: {
    ...
    purpose:
      'Indicates functional programming usage and potential complexity from nested callbacks.',
    ...
    industryStandards:
      'Depends on programming style. Functional style may have higher counts legitimately.',
    bestPractices: [
  ...
  commentLines: {
    ...
    purpose:
      'Indicates documentation level. Balance between under-documented and over-commented code.',
    ...
    industryStandards:
      'Varies by team and context. Critical functions should have more comments than simple utilities.',
    bestPractices: [
  ...
  codeToCommentRatio: {
    ...
    purpose:
      'Indicates documentation density. Helps balance between under-documented and over-commented code.',
    ...
    industryStandards:
      'Typically 10-30% comments. Higher for complex algorithms, lower for self-explanatory code.',
    bestPractices: [
  ...
  halsteadVolume: {
    ...
    category: 'advanced',
    definition:
      'Software science metric measuring the size of implementation based on operators and operands.',
    purpose:
      'Indicates information content and potential for errors. Higher volume suggests more complex implementation.',
    calculation:
      'V = N * log2(n), where N is total operators and operands, n is unique operators and operands.',
    thresholds: {
    ...
    industryStandards:
      'Academic metric with limited industry adoption. Useful for research and detailed analysis.',
    bestPractices: [
  ...
  halsteadDifficulty: {
    ...
    category: 'advanced',
    definition:
      'Software science metric measuring how difficult the code is to understand and modify.',
    ...
    industryStandards:
      'Academic metric. Higher values suggest need for refactoring or better documentation.',
    bestPractices: [
  ...
  maintainabilityIndex: {
    ...
    category: 'advanced',
    definition:
      'Composite metric combining cyclomatic complexity, lines of code, and Halstead volume to assess maintainability.',
    purpose:
      'Provides overall assessment of how maintainable the code is. Higher values indicate easier maintenance.',
    calculation:
      'MI = 171 - 5.2 * ln(V) - 0.23 * CC - 16.2 * ln(LOC), where V=Halstead Volume, CC=Cyclomatic Complexity, LOC=Lines of Code.',
    thresholds: {
    ...
    industryStandards:
      'Microsoft uses: >85 (green), 65-85 (yellow), <65 (red). Many tools adopt similar thresholds.',
    bestPractices: [
...
export const CONCEPT_EXPLANATIONS: Record<string, ConceptExplanation> = {
  complexity: {
    ...
    importance:
      'Complex code leads to more bugs, longer development time, and higher maintenance costs. Managing complexity is crucial for software quality.',
    keyPrinciples: [
  ...
  maintainability: {
    ...
    definition:
      'The ease with which software can be modified to correct faults, improve performance, or adapt to changed requirements.',
    importance:
      "Maintainable code reduces long-term costs and enables faster feature development. It's essential for sustainable software development.",
    keyPrinciples: [
  ...
  quality: {
    name: 'Code Quality',
    definition:
      'The degree to which code meets specified requirements and is free from defects, while being maintainable and efficient.',
    importance:
      "High-quality code reduces bugs, improves performance, and makes development more efficient. It's fundamental to successful software projects.",
    keyPrinciples: [
  ...
  testing: {
    name: 'Code Testing',
    definition:
      'The practice of verifying that code works correctly and meets requirements through automated and manual verification.',
    importance:
      'Testing ensures code reliability, enables safe refactoring, and provides documentation of intended behavior.',
    keyPrinciples: [
  ...
  refactoring: {
    ...
    importance:
      'Refactoring improves code quality, reduces technical debt, and makes future changes easier and safer.',
    keyPrinciples: [
...
export function searchMetrics(searchTerm: string): MetricExplanation[] {
  ...
  return Object.values(METRIC_EXPLANATIONS).filter(
    metric =>

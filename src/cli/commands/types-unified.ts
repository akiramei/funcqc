...
async function executeList(env: CommandEnvironment, options: TypesCommandOptions): Promise<void> {
  ...
  try {
    ...
    const listOptions = filterUndefined({
      ...
      file: options.file,
      name: options.name,
      propEq: options.propEq ? String(options.propEq) : undefined,
      propGe: options.propGe ? String(options.propGe) : undefined,
      propLe: options.propLe ? String(options.propLe) : undefined,
      propGt: options.propGt ? String(options.propGt) : undefined,
      propLt: options.propLt ? String(options.propLt) : undefined,
      methEq: options.methEq ? String(options.methEq) : undefined,
      methGe: options.methGe ? String(options.methGe) : undefined,
      methLe: options.methLe ? String(options.methLe) : undefined,
      methGt: options.methGt ? String(options.methGt) : undefined,
      methLt: options.methLt ? String(options.methLt) : undefined,
      fnEq: options.fnEq ? String(options.fnEq) : undefined,
      fnGe: options.fnGe ? String(options.fnGe) : undefined,
      fnLe: options.fnLe ? String(options.fnLe) : undefined,
      fnGt: options.fnGt ? String(options.fnGt) : undefined,
      fnLt: options.fnLt ? String(options.fnLt) : undefined,
      totalEq: options.totalEq ? String(options.totalEq) : undefined,
      totalGe: options.totalGe ? String(options.totalGe) : undefined,
      totalLe: options.totalLe ? String(options.totalLe) : undefined,
      totalGt: options.totalGt ? String(options.totalGt) : undefined,
      totalLt: options.totalLt ? String(options.totalLt) : undefined,

...
depCommand.command('delete')
  ...
  .option('--confidence-threshold <value>', 'edge confidence threshold for reachability analysis (0-1)', '0.90')
  ...
  .option('--include-static-methods', 'include static class methods in analysis')
  ...
  .option('--exclude-tests', 'exclude test functions from analysis')
  .option('--exclude-exports', 'exclude exported functions from entry points')
  .option('--min-confidence <num>', 'minimum candidate confidence (filter on functions; separate from edge confidence)', '0.8')
  .option('--high-recall', 'enable high-recall analysis (include exports and static methods; keep tests as entry points)')
